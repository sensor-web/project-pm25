...
var convert2Json = function (ctx, region) {
	...
	if (undefined != region.average.pm2_5) {
		...
		region.average.status = aqi.getAQIStatus(ctx, region.average.pm2_5, region.country_code);
		region.average.statusText = aqi.getAQIStatusText(ctx, region.average.pm2_5, region.country_code);
	}
