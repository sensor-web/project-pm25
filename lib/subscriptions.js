...
Subscriptions.prototype.subscribe = function (subscription) {
	subscription = convert2Db(subscription);
...
Subscriptions.prototype.unsubscribe = function (subscription) {
	var db = this._db;
	return new Promise(function(resolve, reject) {
...
Subscriptions.prototype.checkApiKey = function (apiKey, stationId) {
	var db = this._db;
	return new Promise(function(resolve, reject) {
...
var convert2Db = function (subscription) {
...
var convert2Json = function (subscription) {
	return subscription;
};
