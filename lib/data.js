...
var convert2Db = function (ctx, data) {
	if (data.pm1 != undefined) {
		data.pm1 = Number.parseFloat(data.pm1);
	}
	if (data.pm2_5 != undefined) {
		data.pm2_5 = Number.parseFloat(data.pm2_5);
	}
	if (data.pm10 != undefined) {
		data.pm10 = Number.parseFloat(data.pm10);
	}
